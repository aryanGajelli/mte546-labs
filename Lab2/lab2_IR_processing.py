...
import numpy as np
from lab1_rebuild import long_f_inv, medium_f_inv, short_f_inv, normal_distribution
...
distance_data_points = np.linspace(MIN_RANGE, MAX_RANGE, resolution)
mesh_x, mesh_y = np.meshgrid(distance_data_points, distance_data_points)
mesh_x = mesh_x - GRID_OFFSET
mesh_y = mesh_y - GRID_OFFSET

likelihoods_x_axes_sensor_long = []
likelihood_y_axes_sensor_long = []
likelihood_x_axes_sensor_med = []
likelihood_y_axes_sensor_med = []
likelihood_x_axes_sensor_short = []
likelihood_y_axes_sensor_short = []
